# https://github.com/Kazuhito00/YOLOX-ONNX-TFLite-Sample/blob/main/model/yolox_s.onnx
...
def annotate(img, boxes, scores, cls_ids, conf=0.5, class_names=None):
